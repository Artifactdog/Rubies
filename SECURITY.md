...
Rubies 2026.08.06.0 encrypts the local budget payload with AES-256-GCM. The key is derived from the user's password with PBKDF2-SHA-256, a random salt, and 310,000 iterations. A fresh IV and salt are generated for each persisted payload.
